...
<head>
    <title>CERVEZAS MEXICANAS</title>
...
<body>
    ...
    <div id="wrap">
        ...
        <p></p> 
        TODAS LAS RECOMENDACIONES DE CERVEZAS MEXICANAS 
        <p></p>
        <TABLE>
